...
/////// Diffuse:
                ...
                float4 node_9623 = _Time + _TimeEditor;
                float2 node_2055 = (i.uv0+node_9623.g*float2(0,0.2));
...
/////// Diffuse:
                ...
                float2 node_2055 = (i.uv0+node_1293.g*float2(0,0.2));
                float4 _node_8131_var = tex2D(_node_8131,TRANSFORM_TEX(node_2055, _node_8131));
                float3 diffuseColor = (_node_8131_var.rgb*_node_57.rgb*1.0);
